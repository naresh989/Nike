     ...
     >
        ...
        max-sm:text-[72px] max-sm:leading-[82] font-bold'>
           ...
           <span className='xl:bg-white xl:whitespace-nowrap relative z-10 pr-10'>The New Arrival</span>
            ...
            mt-6 mb-14 sm:max-w-sm'>Explore Latest Nike arrivals,quality,comfort and
      ...
      '>
         <img src={bigShoeImg} alt="shoe collection" width={610} height={510} className='relative z-10 object-contain' />
         <div className='flex flex-1 sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%]
          max-sm:px-6'>
            {
               shoes.map((shoe) =>(
                  <div key={shoe}>
                     <ShoeCard imgURL ={shoe} changeShoeImage = {(shoe)=>{setBigShoeImg(shoe)}} bigShoeImg ={bigShoeImg}/>
                  </div>
               ))
            }
         </div>
