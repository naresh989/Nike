  ...
  return (
    ...
    className="max-container max-sm:mt-12">
      <div className="flex flex-1 flex-col justify-start">
        ...
        <p className="lg:max-w-lg mt-2 font-montserrat text-slate-gray">Explore top-notch quality and style with our sought-after selections.Discover a world of comfort, design, and value
        </p>
